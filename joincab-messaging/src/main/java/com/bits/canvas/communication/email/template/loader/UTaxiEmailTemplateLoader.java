...
@Component(value="utaxiEmailTemplate")
public class UTaxiEmailTemplateLoader implements EmailTemplate{

private static final Logger LOG = Logger.getLogger(UTaxiEmailTemplateLoader.class);
	...
	public String getEmailTemplate(MessageDto messageDto) {
		...
		try{
			...
			Template t = ve.getTemplate( "utaxiEmailTemplate.vm" );
			...
			e.printStackTrace();
			LOG.error("Exception while loading email template for Utaxi Email : " + e.getMessage());
		}
		return message;
	}
}