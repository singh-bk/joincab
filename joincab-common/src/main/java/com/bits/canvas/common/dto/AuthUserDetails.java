...
public class AuthUserDetails extends SocialUser{

	/**
	 * 
	 */
	private static final long serialVersionUID = -9193672419683427402L;
	...
	public static class Builder {
		...
		public AuthUserDetails build() {
			AuthUserDetails user = new AuthUserDetails(username, password, authorities);
			user.id = id;
