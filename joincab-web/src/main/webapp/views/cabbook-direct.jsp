...
<body>
	...
	<section class="subheader">
		...
		<div class="ref-search-tab">
			...
			<div class="ref-warning-txt"><span>If you want to share your ride with existing travelers, Click HOP SEARCH on your right.</span></div>
			<a href="#" class="refSearch tab-btn fright">HOP SEARCH</a>
